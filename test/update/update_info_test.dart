...
Map<String, dynamic> releaseJson() => {
  'tag_name': 'v1.2.0',
  'html_url': 'https://github.com/bluegene37/files_utility/releases/tag/v1.2.0',
  'assets': [
    {
      'name': 'FilesUtility-x86_64-1.2.0+3-Installer.exe',
      'browser_download_url': 'https://example.com/installer.exe',
      'size': 12345,
    },
    {
      'name': 'Files.Utility-1.2.0.dmg',
      'browser_download_url': 'https://example.com/app.dmg',
      'size': 22222,
    },
    {
      'name': 'files-utility_1.2.0_amd64.deb',
      'browser_download_url': 'https://example.com/app.deb',
      'size': 33333,
    },
    {
      'name': 'files-utility-1.2.0-linux-x64.tar.gz',
...
void main() {
  group('UpdateInfo.fromReleaseJson', () {
    ...
    test('falls back to tarball on Linux when no .deb exists', () {
      ...
      final info = UpdateInfo.fromReleaseJson(json, UpdatePlatform.linux);
    ...
    test('asset is null when the platform has no matching asset', () {
      final json = releaseJson();
      json['assets'] = <dynamic>[];
      final info = UpdateInfo.fromReleaseJson(json, UpdatePlatform.windows);
